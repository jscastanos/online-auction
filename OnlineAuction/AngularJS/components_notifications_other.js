...
$(function() {
    ...
    notes['error'] = 'Filled all necessary information';
    notes['success'] = 'You successfully updated the data';
    notes['information'] = 'You successfully save the data';
