...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.search = function (q) {
        ...
        this.searchResults = [];
        if (q != "") {
            this.searchProduct = this.productsService.getSearchProduct(q).subscribe(function (data) {
    ...
    HomePage.prototype.fetchNotifCount = function () {
        var _this = this;
        this.fetchNotif = this.profileService.notifs(this.user.id).subscribe(function (data) {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.productsService.getDisplayItems(this.lazyLoadIndex.display)
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.productsService.getAuctionItems(this.lazyLoadIndex.auction)
                                .subscribe(function (data) {
                                for (var index in data) {
